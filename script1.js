...
let USAATime = new Job ("USAA", new Date(2019,11,02), new Date());
let signatureTime = new Job("Signature", new Date(2018, 11, 01), new Date(2019,10,31));
...
document.getElementById("USAATime").innerHTML = USAATime.getJobDuration();
